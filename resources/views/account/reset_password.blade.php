...
<head>
    ...
    <title>Reset Password | {{$settings['Site name']}}</title>
    ...
    <link rel="stylesheet" href="{{url('assets/css/setup.css?v=1.1')}}">
                    ...
                    <div class="row">
                        ...
                        <form method="post" class="mx-auto" id="login_form">
                            ...
                            <div class="col-12">
                                        ...
                                        <input class="form-control" type="password" name="password" placeholder="" required id="pass1">
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <button class="btn btn-info rounded-pill btn-sm mb-3 w-100" id="submit_btn" style="font-size: 17px;">Update Password</button>
                                </div>
                            </div>

                            <div class="row gy-3 p-4" id="success_box" style="display: none;">
                                <div class="col-12">
                                    <p class="alert alert-success">Password updated successfully!</p>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
       ...
       e.preventDefault();
        ...
        $.ajax({
            url: "<?php echo url('password/reset') ?>",
            type: "POST",
            data:  formData,
            ...
            success: function(data) { //alert(data);
                ...
                if ( ! data.success) {
                    ...
                    {
                        $("#login_error").text("Email address is not valid.");
                        $("#login_error").show();
                        $("#submit_btn").attr('disabled', false);
                        $("#submit_btn").text('Submit');
                    }
