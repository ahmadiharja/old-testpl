@include('common.navigations.header')
        ...
        <main class="main-vertical-layout">
           <div class="container-fluid">
               ...
               <a href="{{url('workgroups-info/'.$item->workgroup->id)}}">
                    <button class="btn btn-info btn-sm rounded-pill" type="button">Back to Workgroup</button>
               </a>
              
               <nav aria-label="breadcrumb">
                 <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#" class="text-decoration-none">{!!$item->workgroup->facility->link!!}</a></li>
                  <li class="breadcrumb-item"><a href="#" class="text-decoration-none">{!!$item->workgroup->link!!}</a></li>
                ...
                <section class="py-4">
                    <div class="bg-white border rounded border-info rounded-4 pt-4">
                        <div class="d-flex flex-column justify-content-between align-items-center flex-sm-row px-4 mb-3">
                            <div>
                                <h5 class="text-primary mb-0">Workstation</h5>
                            </div>
                            ...
                            <table class="table mb-0 table-light">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="border-0">
                                            <div class="row">
                                                <div class="col-12"><b>Workstation Name</b>
                                                <br><span class="text-muted">{{$item->name}}</span></div>
                                            </div>
                                        </td>
                                        <td class="border-0">
                                            <div class="row">
                                                <div class="col-12 font-weight-bold"><b>Workgroup</b>
                                                    <br><a href="#" style="text-decoration: none;">{!!$item->workgroup->link!!}</a></div>
                                            </div>
                                        </td>
                                        <td class="border-0" >
                                            <div class="row">
                                                <div class="col-12"><b>facility</b>
                                                 <br><a href="#" style="text-decoration: none;">{!!$item->workgroup->facility->link!!}</a></div>
                                            </div>
                                        </td>
                                        <td class="border-0">
                                            <div class="row">
                                                <div class="col-12 font-bold"><b>Department</b>
                                                    @if($item->department=='')
                                                    <br><span class="text-muted">-</span>
                                                    @else
                                                    <br><span class="text-muted">{{$item->department}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="border-0">
                                             <div class="row">
                                                <div class="col-12 font-weight-bold"><b>Room Number</b>
                                                    @if($item->location=='')
                                                    <br><span class="text-muted">-</span>
                                                    @else
                                                    <br><span class="text-muted">{{$item->location}}</span>
                                                    @endif
                                                 </div>
                                            </div>
                                        </td>
                                       ...
                                       <tr>
                                        <td class="border-0">
                                            <div class="row">
                                                <div class="col-12"><b>Last Connected</b>
                                                <br><span class="text-muted">{{$item->last_connected}}</span></div>
                                            </div>
                                        </td>
                                           @if ($license = $item->preference('QA_license')!=''?$item->preference('QA_license'):($item->preference('Cal_license')!=''?$item->preference('Cal_license'):'') )
                                        <td class="border-0">
                                            <div class="row">
                                                <div class="col-12 font-weight-bold"><b>License Code</b>
                                                 <br><span class="text-muted">{{$license}}</span></div>
                                            </div>
                                        </td>
                                           @endif
                                        <td class="border-0">
                                            <div class="row">
                                                <div class="col-12 font-weight-bold"><b>Calibrate License</b>
                                                 <br><span class="text-muted">{{$item->preference('Cal_license')!=''?'Yes':'No'}}</span></div>
                                            </div>
                                        </td>
                                        <td class="border-0">
                                            <div class="row">
                                                <div class="col-12 font-bold"><b>Qa License</b>
                                                    <br><span class="text-muted">{{$item->preference('QA_license')!=''?'Yes':'No'}}</span></div>
                                            </div>
                                        </td>
                                        
                                        <td class="border-0">
                                             <div class="row">
                                                <div class="col-12 font-weight-bold"><b>Client Version</b>
                                                    <br><span class="text-muted">{{$item->client_version}}</span></div>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div class="container-fluid mb-5 pb-5">
                <section class="py-4">
                    <div class="bg-white border rounded border-info rounded-4 pt-4">
                        <div class="d-flex flex-column justify-content-between align-items-center flex-sm-row px-4 mb-3">
                            <div>
                                <h5 class="text-primary mb-0">{{$item->name}}'s Displays</h5>
                            </div>
                            
                        </div>
                        <div class="table-responsive rounded-4">
                            <table class="table mb-0 table-light" style="width:100%;" id="table-display">
                                <thead>
                                ...
                                <tbody>
                                    @if(0)
                                    <tr>
                                        <td class="text-nowrap text-primary">Dell DELL UP2716D (KRXTR66E083L)</td>
                                        <td class="text-body">-</td>
                                         <td class="text-right">
                                            <div class="dropdown"><button class="btn btn-more px-1 py-0" aria-expanded="false" data-bs-toggle="dropdown" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-192 0 512 512" width="1em" height="1em" fill="currentColor" class="fs-5">
...
<a class="dropdown-item" href="#"><span class="d-inline-block me-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    ...
    var table = $('#table-display').DataTable({
        ...
        "ajax": {
            "url": "{{url('list-displays?workstation_id='.$item->id)}}",  // URL to the script that provides data
        ...
        "columns": [
            {   "data": "id", "visible": false },
                ...
                { "data": "inventoryNumber", sortable: false, searchable: false, "defaultContent":"" , className: "text-body"},
