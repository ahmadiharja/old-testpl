...
class qualityAssurance extends Controller
{
    public function quality_assuarance(Request $request){
        ...
        if($request->input('displays')!='')
        {
            ...
            return redirect('quality-assurance');
        }
        ...
        /*if($request->input('displays2')!='')
        {
            ...
            return redirect('quality-assuarance');
        }*/
        
        return view('quality_assuarance.index', ['title'=> 'Quality Assurance', 'facilities'=> $facilities]);
    }
